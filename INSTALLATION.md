...
## Dashboard-Karte installieren (Optional aber empfohlen)

Die Integration enthält eine benutzerdefinierte Dashboard-Karte mit professionellem Design.

### Schritt 1: Datei kopieren

1. Kopieren Sie die Datei `www/nfc-alarm-card.js` nach `/config/www/`
2. Falls der `www` Ordner nicht existiert, erstellen Sie ihn
...
7. Leeren Sie den Browser-Cache (Strg + Shift + R)
...
2. Klicken Sie auf **Bearbeiten**
3. Klicken Sie auf **+ Karte hinzufügen**
4. Suchen Sie nach "NFC Alarm Card"
5. Konfigurieren Sie:
   ```yaml
...
**Siehe [DASHBOARD_KARTE.md](DASHBOARD_KARTE.md) für die vollständige Anleitung.**

## Nächste Schritte

- Installieren Sie die Dashboard-Karte für eine bessere Bedienung
