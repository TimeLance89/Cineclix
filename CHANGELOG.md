...
### Hinzugefügt
- **Benutzerdefinierte Dashboard-Karte** (`nfc-alarm-card.js`)
  ...
  - Animierte Übergänge
- Dokumentation für Dashboard-Karte (DASHBOARD_KARTE.md)
- Anleitung zur Installation der Karte in INSTALLATION.md

## [1.0.1] - 2025-11-10

### Behoben
- ImportError bei Alarm-Zustandskonstanten behoben
- Verwendung der offiziellen `AlarmControlPanelState` Enum statt veralteter String-Konstanten
- Kompatibilität mit neueren Home Assistant Versionen sichergestellt
